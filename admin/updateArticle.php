            ...
            <div class="content-box-large">
                ...
                <div class="panel-body">
                  ...
                  $query = $db -> query("SELECT * FROM article
                    ...
                    INNER JOIN user ON user.uid = article.articleUser WHERE article.aid = $_GET[updateArticle]",
                    PDO::FETCH_ASSOC);
                    if ($query->rowCount()) {
                    ...
                    <form class="form-horizontal" action="update.php" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control" id="ckeditor_standard" name="articleContent"
                                          rows="5" required="true"><?php echo $row["articleContent"]; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
